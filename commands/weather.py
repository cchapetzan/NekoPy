...
import click
from Nekopy.services import weather
...
@click.group()
@click.option("-l", "--location", type=str, help="The weather in that location.")
@click.pass_context
...
@click.pass_context
def current(ctx):
    """Let's find the current weather info for you!"""
...
@click.pass_context
def forecast(ctx):
    """Let's find the forecast weather info for you!"""
